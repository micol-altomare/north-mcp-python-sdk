...
mcp = NorthMCPServer("Simple Calculator", host="0.0.0.0", port=_default_port)


@mcp.tool()
def micol_altomare_add(a: int, b: int) -> int:
    """Add two numbers"""
    return a + b


@mcp.tool()
def micol_altomare_subtract(a: int, b: int) -> int:
    """Subtract two numbers"""
    return a - b


@mcp.tool()
def micol_altomare_multiply(a: int, b: int) -> int:
...
def micol_altomare_divide(a: int, b: int) -> int:
    """Divide two numbers"""
    return int(a / b)


@mcp.tool()
def micol_altomare_exponent(a: int, b: int) -> int:
    """
...
@mcp.tool()
def micol_altomare_modulo(a: int, b: int) -> int:
    """Modulo two numbers"""
    return a % b
...
class CalculationRequest(BaseModel):
    ...
    precision: int = Field(
        default=2, description="Decimal precision for the result"
    )


@mcp.tool()
def micol_altomare_batch_calculate(request: CalculationRequest) -> dict:
